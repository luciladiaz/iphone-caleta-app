...
const ORIGEN_LABEL = { venta: 'Venta', cuota: 'Cuota', pago_proveedor: 'Pago a proveedor', pago_proveedor_cc: 'Pago a proveedor', reparacion: 'Reparación', reparacion_costo: 'Repuesto reparación', consignacion_cliente: 'Consignación (cliente)', pago_consignacion_de_cliente: 'Pago a cliente (consignación)', manual: 'Otro' };
